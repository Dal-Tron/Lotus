...
create or replace function delete_storage_object(bucket text, object text, out status int, out content text)
  ...
  security definer as $$
    declare
      project_url text := 'https://sdoqdxkpfxozevgcmzfk.supabase.co';
      service_role_key text := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNkb3FkeGtwZnhvemV2Z2NtemZrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNjQ1NzIzMCwiZXhwIjoyMDIyMDMzMjMwfQ.K_bewYr2Cq13vNVYkBCdrt-MSsHEBBmvI7kQRdlKiLg';
